                  ...
                  <div className="flex-1 min-w-0">
                     ...
                     {nextEvent && (
                       <p className="text-sm text-indigo-600 font-medium mt-1 flex items-center gap-1">
                         ...
                         {nextEvent.title}まで あと{nextEvent.days}日
                       </p>
                     )}
                   ...
                   {futureEvents.map(evt => (
                      ...
                      >
                        ...
                        <div className="text-right shrink-0 min-w-[60px]">
                           {evt.days === 0 ? (
                             <span className="text-sm font-bold text-orange-600">今日</span>
                           ) : (
                             <span className={`text-sm font-bold ${evt.days <= 7 ? 'text-red-600' : 'text-indigo-600'}`}>
                               あと{evt.days}日
                             </span>
                           )}
                        </div>
