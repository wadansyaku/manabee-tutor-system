        ...
        <div className="p-6">
           ...
           {canEditLessonContent && (
             <button
               ...
               className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-indigo-600 to-violet-600 text-white py-3 rounded-lg font-medium hover:from-indigo-700 hover:to-violet-700 disabled:opacity-50 shadow-md transition-all"
             >
               {isProcessing ? (
                 <>AI分析中...</>
               ) : (
